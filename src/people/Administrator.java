...
import static changeData.MessageDoctor.makeDoctorMessage;
...
public class Administrator extends Person implements IViewDoctorRatings, ICreateAccount
{
     ...
     */
    public String createAdministrator(String title, String givenName, String surname, String addressLine1, 
     ...
     * @return boolean
     */
    public String createDoctor(String title, String givenName, String surname, String addressLine1, 
            String addressLine2, String addressLine3, String addressPostcode, 
            String DOB, String password)
    {
        return MakeUser.makeAUser(givenName, surname, addressLine1, 
    ...
    public boolean sendDoctorFeedback(String doctorId)
    {
        return makeDoctorMessage(doctorId);
    }
    /**
     ...
     * @return boolean
     */
    public String createSecretary(String title, String givenName, String surname, 
